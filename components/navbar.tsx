  ...
  const LINKS = [
    {
      ...
      iconActive: <PiHouseFill className="w-6 h-6 text-theme-500" />,
    },
    {
      name: "Movies",
      href: "/movie",
      icon: <PiFilmStrip className="w-6 h-6" />,
      iconActive: <PiFilmStripFill className="w-6 h-6 text-theme-500" />,
    },
    {
      name: "TV Shows",
      href: "/tv",
      icon: <PiTelevision className="w-6 h-6" />,
      iconActive: <PiTelevisionFill className="w-6 h-6 text-theme-500" />,
    },
    {
      name: "Search",
      href: "/search",
      icon: <PiMagnifyingGlass className="w-6 h-6" />,
      iconActive: <PiMagnifyingGlassFill className="w-6 h-6 text-theme-500" />,
    },
  ];
